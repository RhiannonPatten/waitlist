...
data_clean%>%
  ggplot(
    aes(waiting_time_yrs, fill=cvdrisk_index_merged, by=waiting_time_yrs))+
   geom_bar(position = "fill")+
  labs(y="Proportion")

data_clean%>%
  ggplot(
    aes(cvdrisk_index_merged, fill=waiting_time_yrs, by=cvdrisk_index_merged))+
   geom_bar(position = "fill")+
  labs(y="Proportion")
...
data_clean%>% ggplot(aes(as_factor(alcohol), fill=as_factor(cvdrisk_index_merged), by=as_factor(alcohol)))+
   geom_bar(position = "fill")+
  labs(y="Proportion")
...
data_clean%>% ggplot(aes(as_factor(cvdrisk_index_merged), fill=as_factor(EQ5D_anxdep), by=as_factor(cvdrisk_index_merged)))+
   geom_bar(position = "fill")+
  labs(y="Proportion")
```
...
data_clean%>% ggplot(aes(as_factor(oa_check), fill=as_factor(cvdrisk_index_merged), by=as_factor(oa_check)))+
   geom_bar(position = "fill")+
  labs(y="Proportion")
```
